...
#import "XCryptoHeader.h"

@interface ViewController()<NSTableViewDelegate,NSTableViewDataSource,XCryptoManagerProtocol>
...
- (IBAction)startAction:(NSButton *)sender {
    ...
    [[XCryptoManager sharedManager] sendAESCBCXCryptoRequest:self requestParam:param callbackParam:@"/Users/wjg/Downloads/finished_upload_20171103.zip"];
    
    [[XCryptoManager sharedManager] sendAESCBCXCryptoRequest:self requestParam:paramb callbackParam:@"/Users/wjg/Documents/enzp.zip"];
}

- (IBAction)stopAction:(NSButton *)sender {
    
    [[XCryptoManager sharedManager] cancelXCryptoRequest:self requestTag:@"/Users/wjg/Downloads/finished_upload_20171103.zip"];
    //
    [[XCryptoManager sharedManager] cancelXCryptoRequest:self requestTag:@"/Users/wjg/Documents/enzp.zip"];
}
